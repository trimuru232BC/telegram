...
sto = {"stop":False}
token = "6404254227:AAGW7wUq7czTeD3SRoDGCvEqUA0xaB-slsI" 
id = 5244246071
...
def start(message):
 bot.send_message(message.chat.id,"   MemchoXD \n  𝗪𝗼𝗿𝗸𝗶𝗻𝗴 𝗕𝗼𝘁  \n  𝐘𝐨𝐮 𝐚𝐫𝐞 𝐂𝐨𝐦𝐛𝐨 𝐭𝐱𝐭 𝐅𝐢𝐥𝐞 𝐒𝐞𝐧𝐝 𝐍𝐨𝐰 UwU".format(message.chat.first_name),reply_markup=telebot.types.InlineKeyboardMarkup())
...
<a href='t.me/CHITNGE54'>━━━━━━━━━━━━━━━━━━</a>
<a href='t.me/CHITNGE54'>[↯]</a> 𝗖𝗛𝗞 𝗕𝗢𝗧 ↯ <a href='https://t.me/trimuru2023'> 𓆩mem-cho [ 🇻🇳 ] </a>
<a href='t.me/CHITNGE54'>[↯]</a> 𝗕𝗢𝗧 𝗕𝗬 ↯ <a href='https://t.me/trimuru2023'>mem-cho [ 🇻🇳 ] </a>
<a href='https://t.me/trimuru2023'>[↯]</a> 𝗣𝗥𝗢𝗫𝗬  ↯ <code>𝗟𝗶𝘃𝗲 [1XX.XX.XX 🟢]</code>
<a href='t.me/CHITNGE54'>━━━━━━━━━━━━━━━━━━</a>''')
               print(Fore.YELLOW+cc+"->"+Fore.GREEN+last)
               bot.reply_to(message,respo)
               with open("hit.txt", "a") as f:
